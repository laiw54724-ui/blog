...
import {
  getResolvedCoverAssetsMap,
  getEntryMetricsMap,
} from './data'
import { extractPlainText, stripLeadingMarkdownTitle, getFirstMeaningfulParagraph } from './markdown'
...
export function getPublicApiBase(): string {
  if (typeof import.meta !== 'undefined' && (import.meta as any).env && (import.meta as any).env.PUBLIC_API_URL) {
